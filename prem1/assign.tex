...
\solution  PMF calculates the probability of obtaining exactly "k" successes in a fixed number of "n" independent trials, each with a probability of success "p."
\\
