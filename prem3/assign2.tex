...
\solution  Let X be an bernoulli rv defined as,\\
\begin{table}[h]
\centering
\caption{Declaration of x}
\begin{tabular}{|c|c|c|}
\hline
RV & value & Description\\
\hline
$X$ & 0 & not getting desired outcome \\
\hline
$X$ & 1 & getting desired outcome\\
\hline
\end{tabular}
\end{table}\\
...
\end{cases}
\end{align}\\
The probability of getting 1 at $Pr(X=1)$ is denoted by $ X_1$,\\
\begin{align}
Pr(X_1=1) &= \frac{1}{6}
\end{align}\\
The probability of getting 4at $Pr(X=1)$ is denoted by $ X_2$,\\
\begin{align}
Pr(X_2=1) &= \frac{1}{6}
\end{align}\\
Now representing Y as binomial distribution,\\
\begin{align}
Y&=Pr(X_1=1 and X_2=1)\\
